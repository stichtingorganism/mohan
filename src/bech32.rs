...
pub enum Error {
    ...
    #[fail(display = "missing human-readable separator, \"1\"")]
    MissingSeparator,
...
impl<'a> Bech32Writer<'a> {
    ...
    /// compliance.
    pub fn new(hrp: &str, fmt: &'a mut dyn fmt::Write) -> Result<Bech32Writer<'a>, fmt::Error> {
